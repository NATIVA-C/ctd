...
echo
curl -XPUT 'http://192.168.11.173:9200/twitter'
echo
curl -XPUT 'http://192.168.11.173:9200/twitter/_mapping' -d '{
	"tweet": {
...
echo
curl -XPUT 'http://192.168.11.173:9200/twitter/tweet/1' -d '{
	"user" : "mobz",
...
echo
curl -XPUT 'http://192.168.11.173:9200/twitter/tweet/2' -d '{
	"user" : "mobz",
...
echo
curl -XPUT 'http://192.168.11.173:9200/twitter/tweet/3' -d '{
	"user" : "mobz",
