curl -XDELETE 'http://192.168.11.173:9200/multi_field_type'
echo
curl -XPUT 'http://192.168.11.173:9200/multi_field_type'
echo
curl -XPUT 'http://192.168.11.173:9200/multi_field_type/map1/_mapping' -d '{
	"map1": {
		"properties": {
			"field1": {
				"type": "string",
...
echo
curl -XPUT 'http://192.168.11.173:9200/multi_field_type/map1/1' -d '{
...
echo
curl -XPUT 'http://192.168.11.173:9200/multi_field_type/map1/2' -d '{
...
echo
curl -XPUT 'http://192.168.11.173:9200/multi_field_type/map1/3' -d '{
...
echo
curl -XPUT 'http://192.168.11.173:9200/multi_field_type/map1/4' -d '{
