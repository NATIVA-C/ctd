describe("app.services.Cluster", function() {
	...
	beforeEach( function() {
		cluster = new Cluster({ base_uri: "http://192.168.11.173:9200/" });
	});

	describe( "when it is initialised", function() {

		it("should have a 192.168.11.173 base_uri", function() {
			expect( cluster.base_uri ).toBe( "http://192.168.11.173:9200/" );
		});
